---
description: Generate BDD scenarios + step definitions for ANY framework/language AND immediately import to Vansah using vansah-import.exe — all in one shot.
---
